            ...
            "emails": [
                {
                    ...
                    "received_at": serialize_datetime(e.received_at),
                    "category": e.category,
                    "summary": e.summary,
...
def get_email_detail_func(email_id: int) -> Dict:
    ...
    try:
        ...
        return {
            ...
            "received_at": serialize_datetime(email.received_at),
            ...
            "events": [
                {
                    ...
                    "event_time": serialize_datetime(e.event_time),
                    "location": e.location,
...
def get_event_detail_func(event_id: int) -> Dict:
    ...
    try:
        ...
        return {
            ...
            "event_time": serialize_datetime(event.event_time),
