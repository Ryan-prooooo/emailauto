...
# MCP_EML_PARSER_ARGS=--directory,C:/path/to/eml_parser_mcp,run,eml_parser_mcp.py
# MCP_EML_PARSER_CWD=C:/path/to/eml_parser_mcp
```
...
- **前端界面**: http://localhost:8000/ （仪表盘、邮件、事件、设置、AI助手）
